import { S as reactExports, J as jsxRuntimeExports, a as React } from "./server-BvC2xYzS.js";
import { s as setSection, u as useSection, S as SECTIONS, a as stepSection } from "./router-BQfSjLlM.js";
...
function NetworkGraph() {
  ...
  reactExports.useEffect(() => {
    ...
    const rotYv = 3e-3;
    let t = 0;
    const drag2 = { on: false, sx: 0, sy: 0, rx: 0, ry: 0 };
    ...
    const project = (x, y, z) => {
      const fov = 400;
      const s = fov / (fov - z);
      const cx2 = W >= 768 ? W * 0.7 : W / 2;
      return { px: cx2 + x * s, py: H / 2 + y * s, scale: s };
    };
    let raf = 0;
    const draw = () => {
      ctx.clearRect(0, 0, W, H);
      t += 0.012;
      if (!drag2.on && !nodeDrag.on) rotY += rotYv;
      const proj = nodes.map((n) => {
        const r2 = rot(n.x + n.ox, n.y + n.oy, n.z + n.oz, rotX, rotY);
        const p = project(r2.x, r2.y, r2.z);
        return { px: p.px, py: p.py, z: r2.z, scale: p.scale, node: n };
      });
      links.forEach((l, i) => {
      ...
      [...proj].sort((a, b) => a.z - b.z).forEach((p) => {
        ...
        const r2 = 16 * s;
        const g = ctx.createRadialGradient(p.px, p.py, 0, p.px, p.py, r2 * 2);
        g.addColorStop(0, n.color + "55");
        g.addColorStop(1, "transparent");
        ctx.beginPath();
        ctx.arc(p.px, p.py, r2 * 2, 0, Math.PI * 2);
        ctx.fillStyle = g;
        ctx.fill();
        ctx.beginPath();
        ctx.arc(p.px, p.py, r2, 0, Math.PI * 2);
        ...
        if (s > 0.6) {
          ...
          ctx.fillText(n.label, p.px, p.py + r2 + 3);
        }
      });
    ...
    const onDown = (e) => {
      ...
      if (idx >= 0) {
        ...
        nodeDrag.on = true;
        nodeDrag.idx = idx;
        nodeDrag.sx = e.clientX;
        nodeDrag.sy = e.clientY;
        nodeDrag.ox = n.ox;
        nodeDrag.oy = n.oy;
        nodeDrag.oz = n.oz;
      } else {
    ...
    const onMove = (e) => {
      ...
      if (drag2.on) {
        rotY = drag2.ry + (e.clientX - drag2.sx) * 5e-3;
        rotX = Math.max(-1, Math.min(1, drag2.rx + (e.clientY - drag2.sy) * 5e-3));
      }
    };
    const onUp = () => {
      drag2.on = false;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-full min-h-[420px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "canvas",
    {
      ref: canvasRef,
...
const naeimPhoto = "/assets/naeim-D2Y2PxhG.jpg";
function HomeSection() {
  const [titleNumber, setTitleNumber] = reactExports.useState(0);
  const titles = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[280px_1fr] lg:gap-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-sm rounded-2xl border border-border bg-card/80 p-6 shadow-sm backdrop-blur-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-1 rounded-full bg-gradient-to-tr from-primary via-foreground/30 to-primary opacity-60 blur-sm" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 inline-flex items-center gap-2 rounded-full border border-border bg-muted px-3 py-1 text-[11px] text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-base font-semibold", children: "Naeim Najafvand Drikvand" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground", children: "IT-Systemadministrator · Berlin" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-5 space-y-1.5 text-xs text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
          ...
          " Naeim4naeim@gmail.com"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "secondary", size: "sm", className: "gap-4", children: [
        "IT Infrastructure Expert · Berlin ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(MoveRight, { className: "h-4 w-4" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "max-w-2xl text-4xl font-regular tracking-tighter md:text-6xl lg:text-7xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "IT-Infrastruktur" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex w-full overflow-hidden text-left md:pb-2 md:pt-1", children: [
          " ",
          titles.map((title, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.span,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xl text-base leading-relaxed tracking-tight text-muted-foreground md:text-lg", children: "IT-Systemadministrator aus Berlin mit über 10 Jahren Erfahrung in Linux, Proxmox, pfSense und Windows Server. M.Sc. IT — ich plane, automatisiere und betreibe Infrastrukturen, die einfach laufen." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", className: "gap-4", onClick: () => setSection("contact"), children: [
        "Kontakt aufnehmen ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(MoveRight, { className: "h-4 w-4" })
      ] }) })
    ] })
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-[0.3em] text-primary", children: "01 · Über mich" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-2 text-3xl font-bold tracking-tight md:text-5xl", children: [
      "Wer ich ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "bin" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-3 text-sm leading-relaxed text-muted-foreground md:text-base", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Ich bin ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Naeim Najafvand Drikvand" }),
        " — IT-Systemadministrator mit über ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "10 Jahren internationaler Erfahrung" }),
        ". Mein Weg führte mich vom Iran über Brandenburg bis nach Berlin."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Akademisches Fundament: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Bachelor IT" }),
        " (Esfahan) und",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Master Information Technology" }),
        " (Teheran). Neben klassischer Administration bringe ich Know-how in KI-Tools, Webentwicklung und digitalem Marketing mit."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Mein Fokus: robuste, sichere und skalierbare Systeme — administriert mit Sorgfalt, automatisiert mit Python & Bash, gesichert mit pfSense und Fortinet." })
    ] })
  ] });
}
const groups = [
...
function SkillsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-[0.3em] text-primary", children: "02 · Kompetenzen" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-2 text-3xl font-bold tracking-tight md:text-5xl", children: [
      "Was ich ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "beherrsche" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: groups.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card/70 p-4 backdrop-blur-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: g.cat }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex flex-wrap gap-1.5", children: g.items.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded border border-border bg-muted/50 px-2 py-0.5 text-[11px] font-mono text-muted-foreground", children: i }, i)) })
    ] }, g.cat)) })
  ] });
}
const jobs = [
  {
    tab: "Modul-bildung",
    date: "04/2023 – heute · Berlin",
    role: "IT-Systemadministrator",
    company: "Modul-bildung GmbH",
  ...
  {
    tab: "Chenare",
    date: "06/2018 – 02/2023 · Iran",
    role: "Systemadministrator",
    company: "Chenare Andimeshk",
  ...
  {
    tab: "Sedak",
    date: "12/2017 – 04/2018 · Brandenburg",
    role: "IT-Praktikum",
    company: "Sedak GmbH",
  ...
  {
    tab: "Pegah",
    date: "07/2013 – 01/2016 · Iran",
    role: "Help Desk (Werkstudent)",
    company: "Pegah",
...
function ExperienceSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-[0.3em] text-primary", children: "03 · Berufserfahrung" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-2 text-3xl font-bold tracking-tight md:text-5xl", children: [
      "Mein ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Weg" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex flex-wrap gap-1.5", children: jobs.map((j, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setActive(i),
        className: `rounded-md px-3 py-1.5 font-mono text-[11px] uppercase tracking-wider transition-colors ${active === i ? "bg-primary/15 text-primary border border-primary/40" : "border border-border text-muted-foreground hover:text-foreground"}`,
        children: j.tab
      },
      j.tab
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-wider text-primary", children: job.date }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 text-xl font-bold tracking-tight", children: job.role }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground", children: job.company }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-1.5", children: job.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "relative pl-5 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-0 font-bold text-primary", children: "›" }),
        b
      ] }, b)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-1.5", children: job.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded border border-primary/20 bg-primary/10 px-2 py-0.5 text-[11px] font-mono text-primary", children: t }, t)) })
    ] })
  ] });
}
const contacts = [
  ...
  { icon: MapPin, label: "Standort", value: "An den Klostergärten 45, 12277 Berlin", href: null }
];
function ContactSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-[0.3em] text-primary", children: "04 · Kontakt" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-2 text-3xl font-bold tracking-tight md:text-5xl", children: [
      "Lass uns ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "sprechen" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-md text-sm text-muted-foreground md:text-base", children: "Verfügbar für Festanstellung oder Freelance-Projekte in Berlin." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: contacts.map(({ icon: Icon2, label, value, href }) => {
      const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col gap-2 rounded-xl border border-border bg-card/70 p-4 backdrop-blur-sm transition-colors hover:border-primary/40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-md bg-primary/10 text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: value })
      ] });
      return href ? /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href, children: inner }, label) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: inner }, label);
    }) })
  ] });
}
const sectionMap = {
...
function Index() {
  ...
  const lockRef = reactExports.useRef(0);
  reactExports.useEffect(() => {
    const COOLDOWN = 750;
    const onWheel = (e) => {
      e.preventDefault();
      const now2 = Date.now();
      if (now2 - lockRef.current < COOLDOWN) return;
      if (Math.abs(e.deltaY) < 8) return;
      lockRef.current = now2;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-auto absolute inset-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NetworkGraph, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none relative z-10 flex h-full items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-2xl lg:max-w-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      opacity: 0,
      y: 24,
      filter: "blur(8px)"
    }, animate: {
      ...
      duration: 0.55,
      ease: [0.22, 1, 0.36, 1]
    }, className: "[&_a]:pointer-events-auto [&_button]:pointer-events-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Active, {}) }, active) }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute left-4 top-1/2 z-20 hidden -translate-y-1/2 flex-col gap-3 md:flex", children: SECTIONS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-6 w-[2px] rounded-full transition-all ${i === idx ? "bg-primary" : "bg-border"}` }, s)) })
  ] });
}
export {
  Index as component
