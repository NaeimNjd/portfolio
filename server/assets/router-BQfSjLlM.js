import { S as reactExports, F as isPromise, G as isRedirect, E as isNotFound, A as invariant, h as createControlledPromise, _ as rootRouteId, H as isServer$1, v as functionalUpdate$1, c as arraysEqual, i as createLRUCache, f as compileDecodeCharMap, a0 as trimPath, Z as rewriteBasepath, g as composeRewrites, Q as processRouteTree, P as processRouteMasks, Y as resolvePath, e as cleanPath, a2 as trimPathRight, N as parseHref, q as executeRewriteInput, B as isDangerousProtocol, T as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, z as interpolatePath, M as nullReplaceEqualDeep, V as replaceEqualDeep$1, K as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, y as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a1 as trimPathLeft, I as joinPaths, a4 as useRouter, m as dummyMatchContext, L as matchContext, W as requireReactDom, p as exactPathTest, U as removeTrailingSlash, R as React, J as jsxRuntimeExports, C as isModuleNotFoundError, a3 as useHydrated, o as escapeHtml, w as getAssetCrossOrigin, x as getScriptPreloadAttrs, b as appendUniqueUserTags, X as resolveManifestCssLink, O as Outlet } from "./server-BvC2xYzS.js";
...
const appCss = "/assets/styles-CWe2X0GS.css";
...
const useSection = () => reactExports.useSyncExternalStore(subscribe, () => current, () => current);
const items = [
  { id: "home", label: "Home" },
...
function SiteNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-6 left-1/2 z-50 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 rounded-full border border-border bg-background/80 px-2 py-1.5 shadow-lg backdrop-blur-md", children: items.map((it) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: isActive ? "rounded-full bg-primary px-3 py-1.5 text-sm font-medium text-primary-foreground" : "rounded-full px-3 py-1.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground",
        children: it.label
      },
      it.id
    );
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Naeim Najafvand Drikvand – IT-Systemadministrator Berlin. Linux, Proxmox, pfSense, Windows Server. M.Sc. IT – 10+ Jahre Erfahrung."
      },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SiteNav, {})
  ] }) });
}
const $$splitComponentImporter = () => import("./index-DjjIsd5j.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio von Naeim Najafvand Drikvand — IT-Systemadministrator in Berlin mit 10+ Jahren Erfahrung."
    }]
  }),
